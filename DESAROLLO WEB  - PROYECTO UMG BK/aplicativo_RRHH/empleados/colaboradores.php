...
<div style="margin-left: 250px; padding: 20px;">
    ...
    <div class="container mt-3">
        <h2 class="text-center mb-4">Solicitudes de Empleo Aprobadas</h2>
        <br>

        <?php 
            session_start();
            require("../empleados/querys_colaboradores.php");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="setAccion('iniciar_proceso_contratacion');">Iniciar proceso de Contratación</button>
            </div>
        </div>
    </div>
</div>
